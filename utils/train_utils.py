...
import os
import options
from models import models_utils, model_gm, occ_gmm
...
def visualize_model_weights(model: torch.nn.Module):
    """
    Prints the model's parameters (weights and biases), showing their names,
    shapes, and the number of elements.
    """
    for name, param in model.named_parameters():
        print(f"{name}, shape: {param.shape}, total params: {param.numel()}")
        # Optionally, print the values of the weights
        # print(param.data)
